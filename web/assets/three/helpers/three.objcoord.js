...
THREE.ObjCoord = function (object3d) {
    this.screenPosition = function (camera) {
        return THREE.ObjCoord.screenPosition(object3d, camera);
    };

    this.worldPosition = function () {
        return THREE.ObjCoord.worldPosition(object3d);
    };

    this.cssPosition = function (renderer, camera) {
        return THREE.ObjCoord.cssPosition(object3d, renderer, camera);
    };
 ...
 */
THREE.ObjCoord.worldPosition = function (object3d) {
 ...
 */
THREE.ObjCoord.screenPosition = function (object3d, camera) {
 ...
 * @return {THREE.Vector3}        the screen position
 */
THREE.ObjCoord.cssPosition = function (object3d, camera, renderer) {
 ...
 */
THREE.ObjCoord.convertWorldToScreenSpace = function (worldPosition, camera) {
 ...
 */
THREE.ObjCoord.VisiblePlaneHeight = function (camera, distanceToCamera) {
 ...
 * @param {Number} distanceToCamera    distance from the object to the camera
 */
THREE.ObjCoord.VisiblePlaneWidth = function (camera, renderer, distanceToCamera) {
    var planeHeight = THREE.ObjCoord.VisiblePlaneHeight(camera, distanceToCamera);
